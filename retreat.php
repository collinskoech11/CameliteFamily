     ...
     <section class="workshops">
        ...
        <main class="container3">
            <section class="card">
                <div class="row">
                    <div class="col-md-6">
                        <img src="img/z.jpeg" alt="" class="imgs">
                    </div>
                    <div class="col-md-6">
                        <h3>RETREATS</h3>
                        <p>
                            Our main reason for having retreats is to provide an opportunity for guests and participants  to have the silence, 
                            solitude and spiritual guidance they need in order to deepend and meditate on their prayer life. 
                            We are committed to securing retreat masters who treasure the Church are loyal to it.
                        </p>
                    </div>
                </div>
