...
<!-- Menu Icon -->
        ...
        <section class="localevents">
            <header class="main-header">
                <h1><span>Camelite</span> Family</h1>
                <p>The two main events are:</p>
            </header> 
            <main class="container3">
                <section class="card">
                    <div class="row">
                        <div class="col-md-6">
                            <h3>Camelite study week</h3>
                            <p>Study weeks are held weekly on thursdays from 3pm to 5pm</p>
                            <img src="img/0.jpeg" alt="" class="imgs">
                        </div>
                        <div class="col-md-6">
                            <h3>Seminars</h3>
                            <p>
                                seminars are held virtually 
                            </p>
                            <img src="img/y.jpeg" alt="" class="imgs">
                        </div>
                    </div>
