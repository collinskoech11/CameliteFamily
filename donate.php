...
<!-- Menu Icon -->
   ...
   <section class="mpesapaybill">
       <div class="mpesa">
        <header class="main-header">
            <h1><span>Camelite</span> Family</h1>
            <p>We encourage giving and donations as an act of worship</p>
        </header> 
        <div class="row">
            <div class="col-md-6">
                <img src="img/paybill.jpg" alt="" class="imgs">
            </div>
            <div class="col-md-6">
                <h3>PAYBILL NO.</h3>
                <p>
                   <h2>OUR PAYBILL NUMBER IS :</h2>
                   <h2>OUR ACCOUNT NO IS :</h2>
                </p>
            </div>
        </div>
